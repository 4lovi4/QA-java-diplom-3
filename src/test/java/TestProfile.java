...
public class TestProfile {
    ...
    public void checkLinkToProfile() {
        ...
        ProfilePage profilePage = constructor.stellarHeader.clickProfileLoggedIn();
    ...
    public void checkLinkToConstructor() {
        ...
        constructorLoggedIn.checkConstructorLoggedIn();
        ProfilePage profilePage = constructor.stellarHeader.clickProfileLoggedIn();
        constructor = profilePage.stellarHeader.clickConstructor();
        Assert.assertEquals(ConstructorPage.URL + "/", url());
        constructor.checkConstructorLoggedIn();
        profilePage = constructor.stellarHeader.clickProfileLoggedIn();
        constructor = profilePage.stellarHeader.clickConstructorLogo();
        Assert.assertEquals(ConstructorPage.URL + "/", url());
        constructor.checkConstructorLoggedIn();
    }
